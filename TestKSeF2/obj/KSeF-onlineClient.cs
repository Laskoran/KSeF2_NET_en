...
namespace KSeF_Online
{
    ...
    public partial class Client
    {
        ...
        public virtual System.Threading.Tasks.Task<StatusCredentialsResponse> Online_credentials_credentials_context_grantAsync(GrantContextCredentialsRequest body)
        {
            return Online_credentials_credentials_context_grantAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Dane zostały zapisane</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<StatusCredentialsResponse> Online_credentials_credentials_context_grantAsync(GrantContextCredentialsRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/online/Credentials/ContextGrant");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 202)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<StatusCredentialsResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new ApiException<ExceptionResponse>("Nie znaleziono danych", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 401)
                        {
                            ...
                            throw new ApiException<ExceptionResponse>("Nieautoryzowany dost\u0119p", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 404)
                        {
                            string responseText_ = (response_.Content == null) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Nie znaleziono wyszukiwanej tre\u015bci", status_, responseText_, headers_, null);
                        }
                        else
                        {
        ...
        /// <returns>Dane zostały zapisane</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<StatusCredentialsResponse> Online_credentials_credentials_context_revokeAsync(RevokeContextCredentialsRequest body)
        {
            return Online_credentials_credentials_context_revokeAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Dane zostały zapisane</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<StatusCredentialsResponse> Online_credentials_credentials_context_revokeAsync(RevokeContextCredentialsRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/online/Credentials/ContextRevoke");
        ...
        /// <returns>Dane zostały zapisane</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GenerateTokenResponse> Online_credentials_generate_tokenAsync(GenerateTokenRequest body)
        {
        ...
        /// <returns>Dane zostały zapisane</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GenerateTokenResponse> Online_credentials_generate_tokenAsync(GenerateTokenRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
        ...
        /// <returns>Dane zostały zapisane</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<StatusCredentialsResponse> Online_credentials_credentials_grantAsync(GrantCredentialsRequest body)
        {
        ...
        /// <returns>Dane zostały zapisane</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<StatusCredentialsResponse> Online_credentials_credentials_grantAsync(GrantCredentialsRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
        ...
        /// <returns>Dane zostały zapisane</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<StatusCredentialsResponse> Online_credentials_credentials_revokeAsync(RevokeCredentialsRequest body)
        {
        ...
        /// <returns>Dane zostały zapisane</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<StatusCredentialsResponse> Online_credentials_credentials_revokeAsync(RevokeCredentialsRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
        ...
        /// <returns>Dane zostały zapisane</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<StatusCredentialsResponse> Online_credentials_revoke_tokenAsync(RevokeTokenRequest body)
        {
        ...
        /// <returns>Dane zostały zapisane</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<StatusCredentialsResponse> Online_credentials_revoke_tokenAsync(RevokeTokenRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<StatusCredentialsResponse> Online_credentials_credentials_statusAsync(string credentialsElementReferenceNumber)
        {
        ...
        /// <returns>Poświadczenie wykonane prawidłowo</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<StatusCredentialsResponse> Online_credentials_credentials_statusAsync(string credentialsElementReferenceNumber, System.Threading.CancellationToken cancellationToken)
        {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new ApiException<ExceptionResponse>("Nieprawid\u0142owe wywo\u0142anie", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 401)
                        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<FileResponse> Online_invoice_invoice_getAsync(string kSeFReferenceNumber)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<FileResponse> Online_invoice_invoice_getAsync(string kSeFReferenceNumber, System.Threading.CancellationToken cancellationToken)
        {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SendInvoiceResponse> Online_invoice_invoice_sendAsync(SendInvoiceRequest body)
        {
        ...
        /// <returns>Pomyślnie wysłano fakturę</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SendInvoiceResponse> Online_invoice_invoice_sendAsync(SendInvoiceRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<StatusInvoiceResponse> Online_invoice_invoice_statusAsync(string invoiceElementReferenceNumber)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<StatusInvoiceResponse> Online_invoice_invoice_statusAsync(string invoiceElementReferenceNumber, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<StatusInvoiceResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetPaymentIdentifierReferenceNumbersResponse> Online_payment_payment_identifier_get_reference_numbersAsync(string paymentIdentifier)
        {
        ...
        /// <returns>Pobrano faktury oznaczone identyfikatorem płatności</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetPaymentIdentifierReferenceNumbersResponse> Online_payment_payment_identifier_get_reference_numbersAsync(string paymentIdentifier, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetPaymentIdentifierReferenceNumbersResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<RequestPaymentIdentifierResponse> Online_payment_payment_identifier_requestAsync(RequestPaymentIdentifierRequest body)
        {
        ...
        /// <returns>Wygenerowano identyfikator płatności</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<RequestPaymentIdentifierResponse> Online_payment_payment_identifier_requestAsync(RequestPaymentIdentifierRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 201)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<RequestPaymentIdentifierResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<QuerySyncCredentialsResponse> Online_query_query_credentialsAsync(QuerySyncCredentialsRequest body)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<QuerySyncCredentialsResponse> Online_query_query_credentialsAsync(QuerySyncCredentialsRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<QuerySyncCredentialsResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<FileResponse> Online_query_query_invoice_fetchAsync(string queryElementReferenceNumber, string partElementReferenceNumber)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<FileResponse> Online_query_query_invoice_fetchAsync(string queryElementReferenceNumber, string partElementReferenceNumber, System.Threading.CancellationToken cancellationToken)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<QueryInvoiceAsyncInitResponse> Online_query_query_invoice_initAsync(QueryInvoiceRequest body)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<QueryInvoiceAsyncInitResponse> Online_query_query_invoice_initAsync(QueryInvoiceRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 202)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<QueryInvoiceAsyncInitResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<QueryInvoiceAsyncStatusResponse> Online_query_query_invoice_statusAsync(string queryElementReferenceNumber)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<QueryInvoiceAsyncStatusResponse> Online_query_query_invoice_statusAsync(string queryElementReferenceNumber, System.Threading.CancellationToken cancellationToken)
        {
            if (queryElementReferenceNumber == null)
                throw new System.ArgumentNullException("queryElementReferenceNumber");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<QueryInvoiceAsyncStatusResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<QueryInvoiceSyncResponse> Online_query_query_invoiceAsync(int pageSize, int pageOffset, QueryInvoiceRequest body)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<QueryInvoiceSyncResponse> Online_query_query_invoiceAsync(int pageSize, int pageOffset, QueryInvoiceRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (pageSize == null)
            ...
            try
            {
                ...
                {
                    var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(body, _settings.Value);
                    json_ = "{\r\n    \"queryCriteria\":{\r\n        \"subjectType\":\"subject1\",\r\n        \"type\":\"incremental\",\r\n        \"acquisitionTimestampThresholdFrom\":\"2022-10-27T22:00:00.000Z\",\r\n        \"acquisitionTimestampThresholdTo\":\"2022-11-25T21:59:59.999Z\"\r\n    }\r\n}";
                    var content_ = new System.Net.Http.StringContent(json_);
                    content_.Headers.ContentType = System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json");
                    request_.Content = content_;
                    request_.Method = new System.Net.Http.HttpMethod("POST");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            ...
                            var objectResponse_ = await ReadObjectResponseAsync<QueryInvoiceSyncResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<AuthorisationChallengeResponse> Online_session_authorisation_challengeAsync(AuthorisationChallengeRequest body)
        {
        ...
        /// <returns>Inicjalizacja sesji interaktywnej poprawna</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<AuthorisationChallengeResponse> Online_session_authorisation_challengeAsync(AuthorisationChallengeRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 201)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<AuthorisationChallengeResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>Inicjalizacja sesji interaktywnej poprawna</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<InitSessionResponse> Online_session_session_signed_initAsync(System.IO.Stream body)
        {
        ...
        /// <returns>Inicjalizacja sesji interaktywnej poprawna</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<InitSessionResponse> Online_session_session_signed_initAsync(System.IO.Stream body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 201)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<InitSessionResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>Inicjalizacja sesji interaktywnej poprawna</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<InitSessionResponse> Online_session_session_token_initAsync(System.IO.Stream body)
        {
        ...
        /// <returns>Inicjalizacja sesji interaktywnej poprawna</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<InitSessionResponse> Online_session_session_token_initAsync(System.IO.Stream body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SessionStatusResponse> Online_session_session_status_plainAsync(int? pageSize, int? pageOffset, bool? includeDetails)
        {
            return Online_session_session_status_plainAsync(pageSize, pageOffset, includeDetails, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Sprawdzanie statusu sesji zakończone poprawnie</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SessionStatusResponse> Online_session_session_status_plainAsync(int? pageSize, int? pageOffset, bool? includeDetails, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
        ...
        /// <returns>Sprawdzanie statusu sesji zakończone poprawnie</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SessionStatusResponse> Online_session_session_status_reference_numberAsync(string referenceNumber, int? pageSize, int? pageOffset, bool? includeDetails)
        {
            return Online_session_session_status_reference_numberAsync(referenceNumber, pageSize, pageOffset, includeDetails, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Sprawdzanie statusu sesji zakończone poprawnie</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SessionStatusResponse> Online_session_session_status_reference_numberAsync(string referenceNumber, int? pageSize, int? pageOffset, bool? includeDetails, System.Threading.CancellationToken cancellationToken)
        {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<TerminateSessionResponse> Online_session_session_terminate_plainAsync()
        {
        ...
        /// <returns>Sesja zakończona</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<TerminateSessionResponse> Online_session_session_terminate_plainAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
    ...
    [Newtonsoft.Json.JsonConverter(typeof(JsonInheritanceConverter), "type")]
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class CredentialsIdentifierRequestIndividualType
    {
        [Newtonsoft.Json.JsonProperty("identifier", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Identifier { get; set; }
    ...
    [Newtonsoft.Json.JsonConverter(typeof(JsonInheritanceConverter), "type")]
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class CredentialsIdentifierRequestInstitutionalType
    {
        [Newtonsoft.Json.JsonProperty("identifier", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Identifier { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class CredentialsRoleRequestContextBaseType
    {
        [Newtonsoft.Json.JsonProperty("roleType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public CredentialsRoleRequestContextBaseTypeRoleType RoleType { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class CredentialsRoleRequestContextDescribedType
    {
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public CredentialsRoleRequestContextDescribedTypeRoleType RoleType { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class GrantContextCredentialsRequest
    {
        [Newtonsoft.Json.JsonProperty("grantContextCredentials", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        public GrantContextCredentialsRequestType GrantContextCredentials { get; set; } = new GrantContextCredentialsRequestType();
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class GrantContextCredentialsRequestType
    {
        [Newtonsoft.Json.JsonProperty("contextIdentifier", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        public CredentialsIdentifierRequestInstitutionalType ContextIdentifier { get; set; } = new CredentialsIdentifierRequestInstitutionalType();

        [Newtonsoft.Json.JsonProperty("credentialsIdentifier", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        public CredentialsIdentifierRequestIndividualType CredentialsIdentifier { get; set; } = new CredentialsIdentifierRequestIndividualType();

        [Newtonsoft.Json.JsonProperty("credentialsRole", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        public CredentialsRoleRequestContextDescribedType CredentialsRole { get; set; } = new CredentialsRoleRequestContextDescribedType();
    ...
    public partial class InvoiceHeaderType
    {
        ...
        [Newtonsoft.Json.JsonProperty("subjectByK", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("subjectToKList", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.MinLength(1)]
        [System.ComponentModel.DataAnnotations.MaxLength(100)]
        public System.Collections.Generic.ICollection<SubjectToType> SubjectToKList { get; set; }

        [Newtonsoft.Json.JsonProperty("subjectsAuthorizedList", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.MinLength(1)]
        [System.ComponentModel.DataAnnotations.MaxLength(1)]
        public System.Collections.Generic.ICollection<SubjectAuthorizedType> SubjectsAuthorizedList { get; set; }

        [Newtonsoft.Json.JsonProperty("subjectsOtherList", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.MinLength(1)]
        [System.ComponentModel.DataAnnotations.MaxLength(100)]
    ...
    public partial class InvoicePayloadEncryptedType : InvoicePayloadType
    {
        ...
        public byte[] EncryptedInvoiceBody { get; set; }
    ...
    public partial class InvoicePayloadPlainType : InvoicePayloadType
    {
        ...
        public byte[] InvoiceBody { get; set; }
    ...
    public partial class QueryCriteriaInvoiceIncrementalType : QueryCriteriaInvoiceType
    {
        ...
        /// <summary>
        /// yyyy-MM-dd'T'HH:mm:ss | maximum date range is current time (+ max 6 hours), the difference between date field and #acquisitionTimestampThresholdFrom cannot be greater than 24 months, date field cannot be before #acquisitionTimestampThresholdFrom
        /// </summary>
    ...
    {
        [Newtonsoft.Json.JsonProperty("divisionType", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        ...
        [Newtonsoft.Json.JsonProperty("numberOfParts", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Range(0, int.MaxValue)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class RevokeContextCredentialsRequest
    {
        [Newtonsoft.Json.JsonProperty("revokeContextCredentials", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        public RevokeContextCredentialsRequestType RevokeContextCredentials { get; set; } = new RevokeContextCredentialsRequestType();
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class RevokeContextCredentialsRequestType
    {
        [Newtonsoft.Json.JsonProperty("contextIdentifier", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        public CredentialsIdentifierRequestInstitutionalType ContextIdentifier { get; set; } = new CredentialsIdentifierRequestInstitutionalType();
        ...
        [Newtonsoft.Json.JsonProperty("credentialsRole", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        public CredentialsRoleRequestContextBaseType CredentialsRole { get; set; } = new CredentialsRoleRequestContextBaseType();
    ...
    {
        [Newtonsoft.Json.JsonProperty("invoiceStatusList", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<SessionInvoiceStatusType> InvoiceStatusList { get; set; }
    ...
    {
        [Newtonsoft.Json.JsonProperty("tradeName")]
        [System.ComponentModel.DataAnnotations.StringLength(256, MinimumLength = 1)]
    ...
    //[JsonInheritanceAttribute("pn", typeof(SubjectPersonNameType))]
    //[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    //public partial class SubjectNameType2
    //{
    //    [Newtonsoft.Json.JsonProperty("tradeName")]
    //    [System.ComponentModel.DataAnnotations.StringLength(256, MinimumLength = 1)]
    //    public string TradeName { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum CredentialsRoleRequestContextBaseTypeRoleType
    {

        [System.Runtime.Serialization.EnumMember(Value = @"credentials_manage")]
        Credentials_manage = 0,

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum CredentialsRoleRequestContextDescribedTypeRoleType
    {
    ...
    public enum CredentialsRoleRequestStandardBaseTypeRoleType
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"subunit_manage")]
        Subunit_manage = 9,
    ...
    public enum CredentialsRoleRequestTokenTypeRoleType
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"credentials_manage")]
        Credentials_manage = 4,

        [System.Runtime.Serialization.EnumMember(Value = @"enforcement_operations")]
        Enforcement_operations = 5,
    ...
    public enum CredentialsRoleResponseGrantedForInstitutionTypeRoleType
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"local_government_unit")]
        Local_government_unit = 7,

        [System.Runtime.Serialization.EnumMember(Value = @"local_government_sub_unit")]
        Local_government_sub_unit = 8,

        [System.Runtime.Serialization.EnumMember(Value = @"vat_group_unit")]
        Vat_group_unit = 9,

        [System.Runtime.Serialization.EnumMember(Value = @"vat_group_sub_unit")]
        Vat_group_sub_unit = 10,
    ...
    public enum CredentialsRoleResponseStandardDetailsTypeRoleType
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"local_government_unit")]
        Local_government_unit = 13,

        [System.Runtime.Serialization.EnumMember(Value = @"local_government_sub_unit")]
        Local_government_sub_unit = 14,

        [System.Runtime.Serialization.EnumMember(Value = @"vat_group_unit")]
        Vat_group_unit = 15,

        [System.Runtime.Serialization.EnumMember(Value = @"vat_group_sub_unit")]
        Vat_group_sub_unit = 16,
